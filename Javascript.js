...
*/
/*	CSS:
	-Make both save buttons a nice light blue (logical) color
*/
/*	ROBERT LIST:
	-Check out free bootstrap library
*/
...
function tableAutosize(tableID)
{
	// Find the table
	...
	// Make the horizontal scrollbar dissapear
...
function deleteColumns(doubleDArray)
{
	...
	columnButton.addEventListener('click', function()
	{
		...
		// Autosize div
		tableAutosize("deleteColumnsTable");
...
function areaAutosize(areaID, ongoing)
{
	...
	/*// Add an autosizes for window loads or is resized
	window.addEventListener('load', function() {
		areaAutosize(areaID, false);
	});
